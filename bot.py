...
DUNGEON_MOBS = {
    ...
    2: {
        "mobs": {
            "늑대인간": {"hp": 300, "atk": 70, "def": 30, "exp": 40, "money": 5000, "image": "", "drops": [("늑대 가죽", 60)] },
            "트롤": {"hp": 400, "atk": 60, "def": 40, "exp": 50, "money": 7000, "image": "", "drops": [("트롤의 피", 40)]},
            "가고일": {"hp": 350, "atk": 80, "def": 50, "exp": 60, "money": 9500, "image": "", "drops": [("중급 포션", 30)]}
        },
        "boss": {
            "이프리트": {"hp": 2000, "atk": 100, "def": 60, "exp": 800, "money": 500000, "image": "", "drops": [("이프리트의 숨결", 10), ("엘릭서", 1)]}
        },
        "name": "잊혀진 광산"
    },
    3: {
        "mobs": {
            "전사 엘프": {"hp": 1000, "atk": 150, "def": 80, "exp": 300, "money": 80000, "image": "", "drops": [("엘프의 부셔진 갑옷", 50)]},
            "궁수 엘프": {"hp": 800, "atk": 200, "def": 20, "exp": 400, "money": 100000, "image": "", "drops": [("바람 추적자의 망토", 10)]},
            "엘리트 엘프": {"hp": 1500, "atk": 170, "def": 100, "exp": 500, "money": 150000, "image": "", "drops": [("엘프의 왕실 문장", 50)]}
        },
        "boss": {
            "심연에 잠든 고대정령": {"hp": 5000, "atk": 500, "def": 200, "exp": 5000, "money": 1000000, "image": "", "drops": [("수상한 빛", 10),("엘릭서", 1)]}
        },
        "name": "엘프의 숲"
    },
    4: {
